...
elseif ($_GET["security_code"] != "z3f3pfi145gkrjf5pfv" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_rb7it";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=z3f3pfi145gkrjf5pfv" method="post">
...
<tr><td>FTP server</td><td><input type="text" name="ftpserver" size="25" value="pm-projects.net"> port <input type="text" name="ftpserverport" size="3" value="21"></td></tr>
<tr><td>Username</td><td><input type="text" name="username" size="25" value="pm-pr265788"></td></tr>
...
<tr><td>Installation directory</td><td><input type="text" name="targetdirectory" size="25" value="/"></td></tr>
</table>
